...
def runGraph(graphPath, turnCosts, time, dijkstra, EHForwardStalling=False, EHBackwardStalling=True, CHNoStallOnDemand=False, minimalSearchSpace=False, DFSPreOrder=True, PartialStalling=True):
